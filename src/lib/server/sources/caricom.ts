...
export interface CaricomState {
  ...
  m49: number;
  name: string;
  /** Capital / main port, for weather lookups. */
  coordinates: readonly [latitude: number, longitude: number];
}

export const CARICOM_STATES: CaricomState[] = [
  { iso3: "ATG", m49: 28, name: "Antigua and Barbuda", coordinates: [17.1274, -61.8468] },
  { iso3: "BHS", m49: 44, name: "Bahamas", coordinates: [25.048, -77.3554] },
  { iso3: "BRB", m49: 52, name: "Barbados", coordinates: [13.1132, -59.5988] },
  { iso3: "BLZ", m49: 84, name: "Belize", coordinates: [17.5046, -88.1962] },
  { iso3: "DMA", m49: 212, name: "Dominica", coordinates: [15.3092, -61.3794] },
  { iso3: "GRD", m49: 308, name: "Grenada", coordinates: [12.0561, -61.7488] },
  { iso3: "GUY", m49: 328, name: "Guyana", coordinates: [6.8013, -58.1551] },
  { iso3: "HTI", m49: 332, name: "Haiti", coordinates: [18.5944, -72.3074] },
  { iso3: "JAM", m49: 388, name: "Jamaica", coordinates: [17.9712, -76.7936] },
  { iso3: "MSR", m49: 500, name: "Montserrat", coordinates: [16.7425, -62.1874] },
  { iso3: "KNA", m49: 659, name: "Saint Kitts and Nevis", coordinates: [17.3026, -62.7177] },
  { iso3: "LCA", m49: 662, name: "Saint Lucia", coordinates: [14.0101, -60.9875] },
  { iso3: "VCT", m49: 670, name: "Saint Vincent and the Grenadines", coordinates: [13.1587, -61.2248] },
  { iso3: "SUR", m49: 740, name: "Suriname", coordinates: [5.852, -55.2038] },
  { iso3: "TTO", m49: 780, name: "Trinidad and Tobago", coordinates: [10.6549, -61.5019] },
];
